...
public class MeasureUtil {
    ...
    public static int getNavigationBarHeight(Activity activity) {
        ...
        if (rid > 0) {
            MMLogManager.logD("获取导航栏是否显示true or false" + resources.getBoolean(rid) + ""); //获取导航栏是否显示true or false
        }

        int resourceId = resources.getIdentifier("navigation_bar_height", "dimen", "android");
        if (resourceId > 0) {
            MMLogManager.logD("获取导航栏高度 " + resources.getDimensionPixelSize(resourceId) + ""); //获取高度
